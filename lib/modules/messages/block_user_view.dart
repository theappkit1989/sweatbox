...
import 'package:s_box/modules/messages/block_user_controller.dart';
...
class BlockUserView extends StatelessWidget {
  final blockUserController = Get.put(BlockUserController());
